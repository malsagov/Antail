...
const Trending = () => {
    ...
    const { animeLoading, animeError, animeTrending, fetchMore: fetchMoreTrending, networkStatus } = useAnimePage()
        ...
        <div className="container">
          ...
          <div className={s.searchLanding}>
              <>
                ...
                <button onClick={onPagination} disabled={networkStatus !== 7} className={s.paginationButton}>{networkStatus == 3 || animeLoading  ? 'Loading...' : 'Load more'}</button>
              </>
          </div>
        </div>
      </div>
